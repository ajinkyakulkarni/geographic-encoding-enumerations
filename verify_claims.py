...
CLAIMS = [
    ...
    ("Table 1", "RV 10.75.5  Procrustes m^2",
     R["rv"]["v2_procrustes"]["m2"], "approx", 0.18, 0.006),
    ("Table 1", "RV 10.75.5  Procrustes p",
     R["rv"]["v2_procrustes"]["p_one_sided"], "below", 1e-4, None),
    ("Table 1", "RV 10.75.5  Mantel r",
     R["rv"]["v2_mantel"]["mantel_r"], "approx", 0.767, 0.0015),
    ("Table 1", "RV 10.75.5  Mantel p",
     R["rv"]["v2_mantel"]["p_one_sided"], "below", 1e-4, None),
    ("Appendix A", "RV 10.75.5  constrained-perm: admissible orderings",
     R["rv"]["v2_constrained_perm_null"]["n_admissible"], "approx", 4320, 0),
    ("Appendix A", "RV 10.75.5  constrained-perm: orderings >= observed",
     R["rv"]["v2_constrained_perm_null"]["n_extreme_geq_observed"], "approx", 6, 0),
    ("Appendix A", "RV 10.75.5  constrained-perm p",
     R["rv"]["v2_constrained_perm_null"]["p_constrained"], "approx", 0.0014, 0.0005),
