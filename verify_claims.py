...
CLAIMS = [
    ...
    ("Sec 3.1/App A", "RV 10.75.5  exact two-sided Kendall p",
     R["rv"]["primary"]["p_exact"], "approx", 2.976e-5, 1e-7),
    ...
    ("Appendix A/Table 3", "RV sensitivity: latitude exact p",
     R["rv"]["sensitivity_axis"]["latitude"]["p_exact"], "approx", 5.51e-6, 1e-7),
    ("Appendix A/Table 3", "RV sensitivity: PC1 exact p",
     R["rv"]["sensitivity_axis"]["pc1"]["p_exact"], "approx", 2.976e-5, 1e-7),
    ("Appendix A", "RV sensitivity: paleocourse tau",
     R["rv"]["sensitivity_paleo"]["tau"], "approx", -0.778, 0.0015),
    ("Appendix A/Table 3", "RV sensitivity: paleocourse exact p",
     R["rv"]["sensitivity_paleo"]["p_exact"], "approx", 9.46e-4, 1e-5),
